...
public interface IBaseRepository<T> where T : class
{
    ...
    Task<T?> SingleOrDefaultAsync(Expression<Func<T, bool>> predicate, string? cacheKey = null, int cacheDurationMinutes = 0, CancellationToken cancellationToken = default);
